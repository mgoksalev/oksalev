...
PACKAGES="x11-repo tur-repo termux-x11-nightly xorg-xrandr xfce4 xfce4-terminal mesa-zink vulkan-loader-android virglrenderer-mesa-zink virglrenderer-android pulseaudio dbus chromium hangover-wine hangover-wowbox64"
STEP=2
